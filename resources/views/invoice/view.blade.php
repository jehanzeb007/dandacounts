...
@section('action-btn')
    <div class="float-end">
        <a href="#" class="btn btn-sm btn-primary  cp_link d-none"
                                ...
                                <div class="table-responsive mt-2">
                                    <table class="table mb-0 table-striped">
                                        <tr>
                                            ...
                                            <th class="text-dark">{{ __('P.Deduction') }}</th>
                                            <th class="text-dark">{{ __('Discount') }}</th>
                                            <th class="text-dark">{{ __('Tax') }}</th>
                                            <th class="text-dark">{{ __('Description') }}</th>
                                            <th class="text-right text-dark" width="12%">{{ __('Price') }}
                                                <small
                                                    class="text-danger font-weight-bold">{{ __('total') }}</small>
                                            </th>
                                        </tr>
                                        @php
                                            $totalQuantity = 0;
                                            $totalRate = 0;
                                            $totalPlateformdeduction = 0;
                                            $totalTaxPrice = 0;
                                            $totalDiscount = 0;
                                            $taxesData = [];
                                            $TaxPrice_array = [];
                                        ...
                                        @foreach ($iteams as $key => $iteam)
                                                ...
                                                @php
                                                    ...
                                                    if(!empty($iteam->tax)){
                                                        ...
                                                        $totalRate += $iteam->price+$iteam->plateform_fee;
                                                        $totalPlateformdeduction += $iteam->plateform_fee;
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Auth::user()->priceFormat($iteam->price+$iteam->plateform_fee) }}</td>
                                                <td>{{ \Auth::user()->priceFormat($iteam->plateform_fee) }}</td>
                                                <td>
                                                ...
                                                <td>{!! !empty($iteam->description) ? nl2br($iteam->description) : '-' !!} </td>
                                                @php
                                        ...
                                        <tr>
                                            ...
                                            <td><b>{{ \Auth::user()->priceFormat($totalPlateformdeduction) }}</b></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                {{ \Auth::user()->priceFormat($invoice->getSubTotal()+$totalPlateformdeduction) }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="7"></td>
                                            <td class="text-right"><b>{{ __('P.Deduction Total') }}</b></td>
                                            <td class="text-right">
                                                {{ \Auth::user()->priceFormat($totalPlateformdeduction) }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="7"></td>
