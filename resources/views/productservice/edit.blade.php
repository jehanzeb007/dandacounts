    ...
    <div class="row">
        ...
        <div class="col-md-6 d-none">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::number('sale_price', null, ['class' => 'form-control', 'step' => '0.01', 'placeholder' => __('Enter Sale Price')]) }}
                </div>
            </div>
        </div>
        ...
        <div class="form-group col-md-6 quantity {{$productService->type=='Service' ? 'd-none':''}}">
            ...
            {{ Form::text('quantity', null, ['class' => 'form-control', 'placeholder' => __('Enter Quantity')]) }}
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="btn-box">
