    ...
    <div class="row">
        ...
        <div class="col-md-6 d-none">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::text('sku', time(), ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter SKU')]) }}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 d-none">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::number('sale_price', 0, ['class' => 'form-control', 'required' => 'required', 'step' => '0.01', 'placeholder' => __('Enter Sale Price')]) }}
                </div>
            </div>
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('sale_chartaccount_id', __('Income Account'),['class'=>'form-label', 'required' => 'required']) }}
        ...
        <div class="col-md-6 d-none">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::number('purchase_price', 0, ['class' => 'form-control', 'required' => 'required', 'step' => '0.01', 'placeholder' => __('Enter Purchase Price')]) }}
                </div>
            </div>
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6 quantity d-none">
            {{ Form::label('quantity', __('Quantity'), ['class' => 'form-label']) }}
            {{ Form::text('quantity', 1, ['class' => 'form-control', 'placeholder' => __('Enter Quantity')]) }}
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="btn-box">
