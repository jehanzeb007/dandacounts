...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::text('email', 'N/A', ['class' => 'form-control', 'required' => 'required','placeholder'=>__('Enter Email')]) }}
                </div>
            </div>
        </div>
        <x-mobile  div-class="col-md-4 " name="contact" label="{{ __('Contact') }}" placeholder="{{ __('Enter Contact') }}"></x-mobile>
    ...
    @if(App\Models\Utility::getValByName('billing_display')=='on')
