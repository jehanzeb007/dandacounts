                ...
                <div id="useradd-2" class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                {{ Form::label('billing_display', __('Display Billing in Proposal / Invoice / Bill'), ['class' => 'form-label']) }}
                                <div class=" form-switch form-switch-left">
                                    <input type="checkbox" class="form-check-input" name="billing_display" id="email_tempalte_13" {{ isset($settings['billing_display']) && $settings['billing_display'] == 'on' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="email_tempalte_13"></label>
                                </div>

                                @error('billing_display')
                                <span class="invalid-billing_display" role="alert">
                                    <strong class="text-danger">{{ $message }}</strong>
                                </span>
                                @enderror
                            </div>
